...
import examples.simpleKeystone.*
import examples.simpleKeystone.views.interference.{SimpleKeystoneApplicativeTableBasedInterferenceSpecification, SimpleKeystonePhysicalTableBasedInterferenceSpecification}
...
object SimpleKeystoneExport extends App {
  ...
  /** Keystone where all transactions are considered
    * @group platform_def
    */
  object SimpleKeystoneConfiguredFull
      extends SimpleKeystonePlatform
  ...
  /** Keystone where L1 cache is not used
    * @group platform_def
    */
  object SimpleKeystoneConfiguredNoL1
      extends SimpleKeystonePlatform
  ...
  /** Keystone where only transactions for app4, app1 and app21 are scheduled
    * @group platform_def
    */
  object SimpleKeystoneConfiguredPlanApp21
      extends SimpleKeystonePlatform
  ...
  /** Keystone where only transactions for app22, app1 and app3 are scheduled
    * @group platform_def
    */
  object SimpleKeystoneConfiguredPlanApp22
      extends SimpleKeystonePlatform
