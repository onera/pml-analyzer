...
import examples.simpleKeystone.pml.{
...
/** The interference calculus assumptions for the SimpleKeystone's applications
  ...
  * significantly impact the [[SimpleKeystonePlatform.TeraNet]]
...
trait SimpleKeystoneApplicativeTableBasedInterferenceSpecification
  ...
  self: SimpleKeystonePlatform
    with SimpleKeystoneTransactionLibrary
    with SimpleKeystoneLibraryConfiguration
