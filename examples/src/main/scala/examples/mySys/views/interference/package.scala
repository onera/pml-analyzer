...
/** Package containing an example on a simplification of a TI Keystone platform
  ...
  *   interference assumption modelling
  * @see
  *   [[MySysInterferenceGeneration]] provides an example of interference
  *   analysis for the simplified Keystone platform
  */
