...
import examples.riscv.FU740.views.interference.{FU740ApplicativeTableBasedInterferenceSpecification, FU740InclusiveCacheInterferenceSpecification, FU740PhysicalTableBasedInterferenceSpecification}
