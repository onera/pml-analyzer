...
trait NocC4S4G1B8TransactionLibrary extends TransactionLibrary {
  self: NocC4S4G1B8Platform with NocC4S4G1B8Software =>
  ...
  val tr_rosace_cg0_cl2_C0_BK5_ld: Transaction = Transaction(app_rosace_cg0_cl2_C0 read rosace.ddr.BK5)
  tr_rosace_cg0_cl2_C0_BK5_ld.used

  val tr_rosace_cg0_cl2_C0_BK5_st: Transaction = Transaction(app_rosace_cg0_cl2_C0 write rosace.ddr.BK5)
  ...
  val tr_rosace_cg0_cl3_C0_BK7_ld: Transaction = Transaction(app_rosace_cg0_cl3_C0 read rosace.ddr.BK7)
  tr_rosace_cg0_cl3_C0_BK7_ld.used

  val tr_rosace_cg0_cl3_C0_BK7_st: Transaction = Transaction(app_rosace_cg0_cl3_C0 write rosace.ddr.BK7)
