...
class NocC8S2G1B8Platform(name: Symbol) extends Platform(name) {
  ...
  object rosace extends Composite {
    ...
    object cg0 extends Composite {
      ...
      val L0_2: SimpleTransporter = SimpleTransporter()

      val L0_3: SimpleTransporter = SimpleTransporter()

      val L1_0: SimpleTransporter = SimpleTransporter()

      val L1_1: SimpleTransporter = SimpleTransporter()

      val L2_0: SimpleTransporter = SimpleTransporter()
