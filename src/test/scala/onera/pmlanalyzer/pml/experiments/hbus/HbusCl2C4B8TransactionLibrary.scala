...
trait HbusCl2C4B8TransactionLibrary extends TransactionLibrary {
  ...
  val tr_rosace_cg0_cl1_C0_BK4_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C0 read rosace.ddr.BK4
  )
  tr_rosace_cg0_cl1_C0_BK4_ld.used

  val tr_rosace_cg0_cl1_C0_BK4_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C0 write rosace.ddr.BK4
  )
  ...
  val tr_rosace_cg0_cl1_C1_BK5_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C1 read rosace.ddr.BK5
  )
  tr_rosace_cg0_cl1_C1_BK5_ld.used

  val tr_rosace_cg0_cl1_C1_BK5_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C1 write rosace.ddr.BK5
  )
  tr_rosace_cg0_cl1_C1_BK5_st.used

  val tr_rosace_cg0_cl1_C2_l1_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C2 read rosace.cg0.cl1.C2_L1
  )
  tr_rosace_cg0_cl1_C2_l1_ld.used

  val tr_rosace_cg0_cl1_C2_l1_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C2 write rosace.cg0.cl1.C2_L1
  )
  tr_rosace_cg0_cl1_C2_l1_st.used

  val tr_rosace_cg0_cl1_C2_l2_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C2 read rosace.cg0.cl1.l2
  )
  tr_rosace_cg0_cl1_C2_l2_ld.used

  val tr_rosace_cg0_cl1_C2_l2_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C2 write rosace.cg0.cl1.l2
  )
  tr_rosace_cg0_cl1_C2_l2_st.used

  val tr_rosace_cg0_cl1_C2_BK6_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C2 read rosace.ddr.BK6
  )
  tr_rosace_cg0_cl1_C2_BK6_ld.used

  val tr_rosace_cg0_cl1_C2_BK6_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C2 write rosace.ddr.BK6
  )
  tr_rosace_cg0_cl1_C2_BK6_st.used

  val tr_rosace_cg0_cl1_C3_l1_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C3 read rosace.cg0.cl1.C3_L1
  )
  tr_rosace_cg0_cl1_C3_l1_ld.used

  val tr_rosace_cg0_cl1_C3_l1_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C3 write rosace.cg0.cl1.C3_L1
  )
  tr_rosace_cg0_cl1_C3_l1_st.used

  val tr_rosace_cg0_cl1_C3_l2_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C3 read rosace.cg0.cl1.l2
  )
  tr_rosace_cg0_cl1_C3_l2_ld.used

  val tr_rosace_cg0_cl1_C3_l2_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C3 write rosace.cg0.cl1.l2
  )
  tr_rosace_cg0_cl1_C3_l2_st.used

  val tr_rosace_cg0_cl1_C3_BK7_ld: Transaction = Transaction(
    app_rosace_cg0_cl1_C3 read rosace.ddr.BK7
  )
  tr_rosace_cg0_cl1_C3_BK7_ld.used

  val tr_rosace_cg0_cl1_C3_BK7_st: Transaction = Transaction(
    app_rosace_cg0_cl1_C3 write rosace.ddr.BK7
  )
