...
trait HbusCl8C8B8TransactionLibrary extends TransactionLibrary {
  self: HbusCl8C8B8Platform with HbusCl8C8B8Software =>
  ...
  val tCl0C5_BK0_ld: Transaction = Transaction(app_Cl0C5 read BK0)
  tCl0C5_BK0_ld.used

  val tCl0C5_BK0_st: Transaction = Transaction(app_Cl0C5 write BK0)
  tCl0C5_BK0_st.used
  ...
  val tCl0C7_BK0_ld: Transaction = Transaction(app_Cl0C7 read BK0)
  tCl0C7_BK0_ld.used

  val tCl0C7_BK0_st: Transaction = Transaction(app_Cl0C7 write BK0)
  tCl0C7_BK0_st.used
  ...
  val tCl1C4_BK1_ld: Transaction = Transaction(app_Cl1C4 read BK1)
  tCl1C4_BK1_ld.used

  val tCl1C4_BK1_st: Transaction = Transaction(app_Cl1C4 write BK1)
  tCl1C4_BK1_st.used
  ...
  val tCl1C5_BK1_ld: Transaction = Transaction(app_Cl1C5 read BK1)
  tCl1C5_BK1_ld.used

  val tCl1C5_BK1_st: Transaction = Transaction(app_Cl1C5 write BK1)
  tCl1C5_BK1_st.used
  ...
  val tCl1C6_BK1_ld: Transaction = Transaction(app_Cl1C6 read BK1)
  tCl1C6_BK1_ld.used

  val tCl1C6_BK1_st: Transaction = Transaction(app_Cl1C6 write BK1)
  tCl1C6_BK1_st.used
  ...
  val tCl1C7_BK1_ld: Transaction = Transaction(app_Cl1C7 read BK1)
  tCl1C7_BK1_ld.used

  val tCl1C7_BK1_st: Transaction = Transaction(app_Cl1C7 write BK1)
  tCl1C7_BK1_st.used
  ...
  val tCl2C4_BK2_ld: Transaction = Transaction(app_Cl2C4 read BK2)
  tCl2C4_BK2_ld.used

  val tCl2C4_BK2_st: Transaction = Transaction(app_Cl2C4 write BK2)
  tCl2C4_BK2_st.used
  ...
  val tCl2C5_BK2_ld: Transaction = Transaction(app_Cl2C5 read BK2)
  tCl2C5_BK2_ld.used

  val tCl2C5_BK2_st: Transaction = Transaction(app_Cl2C5 write BK2)
  tCl2C5_BK2_st.used
  ...
  val tCl2C6_BK2_ld: Transaction = Transaction(app_Cl2C6 read BK2)
  tCl2C6_BK2_ld.used

  val tCl2C6_BK2_st: Transaction = Transaction(app_Cl2C6 write BK2)
  tCl2C6_BK2_st.used
  ...
  val tCl2C7_BK2_ld: Transaction = Transaction(app_Cl2C7 read BK2)
  tCl2C7_BK2_ld.used

  val tCl2C7_BK2_st: Transaction = Transaction(app_Cl2C7 write BK2)
  tCl2C7_BK2_st.used
  ...
  val tCl3C4_BK3_ld: Transaction = Transaction(app_Cl3C4 read BK3)
  tCl3C4_BK3_ld.used

  val tCl3C4_BK3_st: Transaction = Transaction(app_Cl3C4 write BK3)
  tCl3C4_BK3_st.used
  ...
  val tCl3C5_BK3_ld: Transaction = Transaction(app_Cl3C5 read BK3)
  tCl3C5_BK3_ld.used

  val tCl3C5_BK3_st: Transaction = Transaction(app_Cl3C5 write BK3)
  tCl3C5_BK3_st.used
  ...
  val tCl3C6_BK3_ld: Transaction = Transaction(app_Cl3C6 read BK3)
  tCl3C6_BK3_ld.used

  val tCl3C6_BK3_st: Transaction = Transaction(app_Cl3C6 write BK3)
  tCl3C6_BK3_st.used
  ...
  val tCl3C7_BK3_ld: Transaction = Transaction(app_Cl3C7 read BK3)
  tCl3C7_BK3_ld.used

  val tCl3C7_BK3_st: Transaction = Transaction(app_Cl3C7 write BK3)
  tCl3C7_BK3_st.used
  ...
  val tCl4C4_L1_ld: Transaction = Transaction(app_Cl4C4 read Cl4.C4_L1)
  tCl4C4_L1_ld.used

  val tCl4C4_L1_st: Transaction = Transaction(app_Cl4C4 write Cl4.C4_L1)
  tCl4C4_L1_st.used

  val tCl4C4_L2_ld: Transaction = Transaction(app_Cl4C4 read Cl4.L2)
  tCl4C4_L2_ld.used

  val tCl4C4_L2_st: Transaction = Transaction(app_Cl4C4 write Cl4.L2)
  tCl4C4_L2_st.used

  val tCl4C4_BK4_ld: Transaction = Transaction(app_Cl4C4 read BK4)
  tCl4C4_BK4_ld.used

  val tCl4C4_BK4_st: Transaction = Transaction(app_Cl4C4 write BK4)
  tCl4C4_BK4_st.used

  val tCl4C5_L1_ld: Transaction = Transaction(app_Cl4C5 read Cl4.C5_L1)
  tCl4C5_L1_ld.used

  val tCl4C5_L1_st: Transaction = Transaction(app_Cl4C5 write Cl4.C5_L1)
  tCl4C5_L1_st.used

  val tCl4C5_L2_ld: Transaction = Transaction(app_Cl4C5 read Cl4.L2)
  tCl4C5_L2_ld.used

  val tCl4C5_L2_st: Transaction = Transaction(app_Cl4C5 write Cl4.L2)
  tCl4C5_L2_st.used

  val tCl4C5_BK4_ld: Transaction = Transaction(app_Cl4C5 read BK4)
  tCl4C5_BK4_ld.used

  val tCl4C5_BK4_st: Transaction = Transaction(app_Cl4C5 write BK4)
  tCl4C5_BK4_st.used

  val tCl4C6_L1_ld: Transaction = Transaction(app_Cl4C6 read Cl4.C6_L1)
  tCl4C6_L1_ld.used

  val tCl4C6_L1_st: Transaction = Transaction(app_Cl4C6 write Cl4.C6_L1)
  tCl4C6_L1_st.used

  val tCl4C6_L2_ld: Transaction = Transaction(app_Cl4C6 read Cl4.L2)
  tCl4C6_L2_ld.used

  val tCl4C6_L2_st: Transaction = Transaction(app_Cl4C6 write Cl4.L2)
  tCl4C6_L2_st.used

  val tCl4C6_BK4_ld: Transaction = Transaction(app_Cl4C6 read BK4)
  tCl4C6_BK4_ld.used

  val tCl4C6_BK4_st: Transaction = Transaction(app_Cl4C6 write BK4)
  tCl4C6_BK4_st.used

  val tCl4C7_L1_ld: Transaction = Transaction(app_Cl4C7 read Cl4.C7_L1)
  tCl4C7_L1_ld.used

  val tCl4C7_L1_st: Transaction = Transaction(app_Cl4C7 write Cl4.C7_L1)
  tCl4C7_L1_st.used

  val tCl4C7_L2_ld: Transaction = Transaction(app_Cl4C7 read Cl4.L2)
  tCl4C7_L2_ld.used

  val tCl4C7_L2_st: Transaction = Transaction(app_Cl4C7 write Cl4.L2)
  tCl4C7_L2_st.used

  val tCl4C7_BK4_ld: Transaction = Transaction(app_Cl4C7 read BK4)
  tCl4C7_BK4_ld.used

  val tCl4C7_BK4_st: Transaction = Transaction(app_Cl4C7 write BK4)
  tCl4C7_BK4_st.used
  ...
  val tCl5C4_L1_ld: Transaction = Transaction(app_Cl5C4 read Cl5.C4_L1)
  tCl5C4_L1_ld.used

  val tCl5C4_L1_st: Transaction = Transaction(app_Cl5C4 write Cl5.C4_L1)
  tCl5C4_L1_st.used

  val tCl5C4_L2_ld: Transaction = Transaction(app_Cl5C4 read Cl5.L2)
  tCl5C4_L2_ld.used

  val tCl5C4_L2_st: Transaction = Transaction(app_Cl5C4 write Cl5.L2)
  tCl5C4_L2_st.used

  val tCl5C4_BK5_ld: Transaction = Transaction(app_Cl5C4 read BK5)
  tCl5C4_BK5_ld.used

  val tCl5C4_BK5_st: Transaction = Transaction(app_Cl5C4 write BK5)
  tCl5C4_BK5_st.used

  val tCl5C5_L1_ld: Transaction = Transaction(app_Cl5C5 read Cl5.C5_L1)
  tCl5C5_L1_ld.used

  val tCl5C5_L1_st: Transaction = Transaction(app_Cl5C5 write Cl5.C5_L1)
  tCl5C5_L1_st.used

  val tCl5C5_L2_ld: Transaction = Transaction(app_Cl5C5 read Cl5.L2)
  tCl5C5_L2_ld.used

  val tCl5C5_L2_st: Transaction = Transaction(app_Cl5C5 write Cl5.L2)
  tCl5C5_L2_st.used

  val tCl5C5_BK5_ld: Transaction = Transaction(app_Cl5C5 read BK5)
  tCl5C5_BK5_ld.used

  val tCl5C5_BK5_st: Transaction = Transaction(app_Cl5C5 write BK5)
  tCl5C5_BK5_st.used

  val tCl5C6_L1_ld: Transaction = Transaction(app_Cl5C6 read Cl5.C6_L1)
  tCl5C6_L1_ld.used

  val tCl5C6_L1_st: Transaction = Transaction(app_Cl5C6 write Cl5.C6_L1)
  tCl5C6_L1_st.used

  val tCl5C6_L2_ld: Transaction = Transaction(app_Cl5C6 read Cl5.L2)
  tCl5C6_L2_ld.used

  val tCl5C6_L2_st: Transaction = Transaction(app_Cl5C6 write Cl5.L2)
  tCl5C6_L2_st.used

  val tCl5C6_BK5_ld: Transaction = Transaction(app_Cl5C6 read BK5)
  tCl5C6_BK5_ld.used

  val tCl5C6_BK5_st: Transaction = Transaction(app_Cl5C6 write BK5)
  tCl5C6_BK5_st.used

  val tCl5C7_L1_ld: Transaction = Transaction(app_Cl5C7 read Cl5.C7_L1)
  tCl5C7_L1_ld.used

  val tCl5C7_L1_st: Transaction = Transaction(app_Cl5C7 write Cl5.C7_L1)
  tCl5C7_L1_st.used

  val tCl5C7_L2_ld: Transaction = Transaction(app_Cl5C7 read Cl5.L2)
  tCl5C7_L2_ld.used

  val tCl5C7_L2_st: Transaction = Transaction(app_Cl5C7 write Cl5.L2)
  tCl5C7_L2_st.used

  val tCl5C7_BK5_ld: Transaction = Transaction(app_Cl5C7 read BK5)
  tCl5C7_BK5_ld.used

  val tCl5C7_BK5_st: Transaction = Transaction(app_Cl5C7 write BK5)
  tCl5C7_BK5_st.used
  ...
  val tCl6C4_L1_ld: Transaction = Transaction(app_Cl6C4 read Cl6.C4_L1)
  tCl6C4_L1_ld.used

  val tCl6C4_L1_st: Transaction = Transaction(app_Cl6C4 write Cl6.C4_L1)
  tCl6C4_L1_st.used

  val tCl6C4_L2_ld: Transaction = Transaction(app_Cl6C4 read Cl6.L2)
  tCl6C4_L2_ld.used

  val tCl6C4_L2_st: Transaction = Transaction(app_Cl6C4 write Cl6.L2)
  tCl6C4_L2_st.used

  val tCl6C4_BK6_ld: Transaction = Transaction(app_Cl6C4 read BK6)
  tCl6C4_BK6_ld.used

  val tCl6C4_BK6_st: Transaction = Transaction(app_Cl6C4 write BK6)
  tCl6C4_BK6_st.used

  val tCl6C5_L1_ld: Transaction = Transaction(app_Cl6C5 read Cl6.C5_L1)
  tCl6C5_L1_ld.used

  val tCl6C5_L1_st: Transaction = Transaction(app_Cl6C5 write Cl6.C5_L1)
  tCl6C5_L1_st.used

  val tCl6C5_L2_ld: Transaction = Transaction(app_Cl6C5 read Cl6.L2)
  tCl6C5_L2_ld.used

  val tCl6C5_L2_st: Transaction = Transaction(app_Cl6C5 write Cl6.L2)
  tCl6C5_L2_st.used

  val tCl6C5_BK6_ld: Transaction = Transaction(app_Cl6C5 read BK6)
  tCl6C5_BK6_ld.used

  val tCl6C5_BK6_st: Transaction = Transaction(app_Cl6C5 write BK6)
  tCl6C5_BK6_st.used

  val tCl6C6_L1_ld: Transaction = Transaction(app_Cl6C6 read Cl6.C6_L1)
  tCl6C6_L1_ld.used

  val tCl6C6_L1_st: Transaction = Transaction(app_Cl6C6 write Cl6.C6_L1)
  tCl6C6_L1_st.used

  val tCl6C6_L2_ld: Transaction = Transaction(app_Cl6C6 read Cl6.L2)
  tCl6C6_L2_ld.used

  val tCl6C6_L2_st: Transaction = Transaction(app_Cl6C6 write Cl6.L2)
  tCl6C6_L2_st.used

  val tCl6C6_BK6_ld: Transaction = Transaction(app_Cl6C6 read BK6)
  tCl6C6_BK6_ld.used

  val tCl6C6_BK6_st: Transaction = Transaction(app_Cl6C6 write BK6)
  tCl6C6_BK6_st.used

  val tCl6C7_L1_ld: Transaction = Transaction(app_Cl6C7 read Cl6.C7_L1)
  tCl6C7_L1_ld.used

  val tCl6C7_L1_st: Transaction = Transaction(app_Cl6C7 write Cl6.C7_L1)
  tCl6C7_L1_st.used

  val tCl6C7_L2_ld: Transaction = Transaction(app_Cl6C7 read Cl6.L2)
  tCl6C7_L2_ld.used

  val tCl6C7_L2_st: Transaction = Transaction(app_Cl6C7 write Cl6.L2)
  tCl6C7_L2_st.used

  val tCl6C7_BK6_ld: Transaction = Transaction(app_Cl6C7 read BK6)
  tCl6C7_BK6_ld.used

  val tCl6C7_BK6_st: Transaction = Transaction(app_Cl6C7 write BK6)
  tCl6C7_BK6_st.used
  ...
  val tCl7C4_L1_ld: Transaction = Transaction(app_Cl7C4 read Cl7.C4_L1)
  tCl7C4_L1_ld.used

  val tCl7C4_L1_st: Transaction = Transaction(app_Cl7C4 write Cl7.C4_L1)
  tCl7C4_L1_st.used

  val tCl7C4_L2_ld: Transaction = Transaction(app_Cl7C4 read Cl7.L2)
  tCl7C4_L2_ld.used

  val tCl7C4_L2_st: Transaction = Transaction(app_Cl7C4 write Cl7.L2)
  tCl7C4_L2_st.used

  val tCl7C4_BK7_ld: Transaction = Transaction(app_Cl7C4 read BK7)
  tCl7C4_BK7_ld.used

  val tCl7C4_BK7_st: Transaction = Transaction(app_Cl7C4 write BK7)
  tCl7C4_BK7_st.used

  val tCl7C5_L1_ld: Transaction = Transaction(app_Cl7C5 read Cl7.C5_L1)
  tCl7C5_L1_ld.used

  val tCl7C5_L1_st: Transaction = Transaction(app_Cl7C5 write Cl7.C5_L1)
  tCl7C5_L1_st.used

  val tCl7C5_L2_ld: Transaction = Transaction(app_Cl7C5 read Cl7.L2)
  tCl7C5_L2_ld.used

  val tCl7C5_L2_st: Transaction = Transaction(app_Cl7C5 write Cl7.L2)
  tCl7C5_L2_st.used

  val tCl7C5_BK7_ld: Transaction = Transaction(app_Cl7C5 read BK7)
  tCl7C5_BK7_ld.used

  val tCl7C5_BK7_st: Transaction = Transaction(app_Cl7C5 write BK7)
  tCl7C5_BK7_st.used

  val tCl7C6_L1_ld: Transaction = Transaction(app_Cl7C6 read Cl7.C6_L1)
  tCl7C6_L1_ld.used

  val tCl7C6_L1_st: Transaction = Transaction(app_Cl7C6 write Cl7.C6_L1)
  tCl7C6_L1_st.used

  val tCl7C6_L2_ld: Transaction = Transaction(app_Cl7C6 read Cl7.L2)
  tCl7C6_L2_ld.used

  val tCl7C6_L2_st: Transaction = Transaction(app_Cl7C6 write Cl7.L2)
  tCl7C6_L2_st.used

  val tCl7C6_BK7_ld: Transaction = Transaction(app_Cl7C6 read BK7)
  tCl7C6_BK7_ld.used

  val tCl7C6_BK7_st: Transaction = Transaction(app_Cl7C6 write BK7)
  tCl7C6_BK7_st.used

  val tCl7C7_L1_ld: Transaction = Transaction(app_Cl7C7 read Cl7.C7_L1)
  tCl7C7_L1_ld.used

  val tCl7C7_L1_st: Transaction = Transaction(app_Cl7C7 write Cl7.C7_L1)
  tCl7C7_L1_st.used

  val tCl7C7_L2_ld: Transaction = Transaction(app_Cl7C7 read Cl7.L2)
  tCl7C7_L2_ld.used

  val tCl7C7_L2_st: Transaction = Transaction(app_Cl7C7 write Cl7.L2)
  tCl7C7_L2_st.used

  val tCl7C7_BK7_ld: Transaction = Transaction(app_Cl7C7 read BK7)
  tCl7C7_BK7_ld.used

  val tCl7C7_BK7_st: Transaction = Transaction(app_Cl7C7 write BK7)
  tCl7C7_BK7_st.used
