...
trait HbusCl4C2B8TransactionLibrary extends TransactionLibrary {
  ...
  val tr_rosace_cg0_cl1_C0_BK2_ld: Transaction = Transaction(app_rosace_cg0_cl1_C0 read rosace.ddr.BK2)
  tr_rosace_cg0_cl1_C0_BK2_ld.used

  val tr_rosace_cg0_cl1_C0_BK2_st: Transaction = Transaction(app_rosace_cg0_cl1_C0 write rosace.ddr.BK2)
  ...
  val tr_rosace_cg0_cl1_C1_BK3_ld: Transaction = Transaction(app_rosace_cg0_cl1_C1 read rosace.ddr.BK3)
  tr_rosace_cg0_cl1_C1_BK3_ld.used

  val tr_rosace_cg0_cl1_C1_BK3_st: Transaction = Transaction(app_rosace_cg0_cl1_C1 write rosace.ddr.BK3)
  ...
  val tr_rosace_cg0_cl2_C0_BK4_ld: Transaction = Transaction(app_rosace_cg0_cl2_C0 read rosace.ddr.BK4)
  tr_rosace_cg0_cl2_C0_BK4_ld.used

  val tr_rosace_cg0_cl2_C0_BK4_st: Transaction = Transaction(app_rosace_cg0_cl2_C0 write rosace.ddr.BK4)
  tr_rosace_cg0_cl2_C0_BK4_st.used

  val tr_rosace_cg0_cl2_C1_l1_ld: Transaction = Transaction(app_rosace_cg0_cl2_C1 read rosace.cg0.cl2.C1_L1)
  tr_rosace_cg0_cl2_C1_l1_ld.used

  val tr_rosace_cg0_cl2_C1_l1_st: Transaction = Transaction(app_rosace_cg0_cl2_C1 write rosace.cg0.cl2.C1_L1)
  tr_rosace_cg0_cl2_C1_l1_st.used

  val tr_rosace_cg0_cl2_C1_l2_ld: Transaction = Transaction(app_rosace_cg0_cl2_C1 read rosace.cg0.cl2.l2)
  tr_rosace_cg0_cl2_C1_l2_ld.used

  val tr_rosace_cg0_cl2_C1_l2_st: Transaction = Transaction(app_rosace_cg0_cl2_C1 write rosace.cg0.cl2.l2)
  tr_rosace_cg0_cl2_C1_l2_st.used

  val tr_rosace_cg0_cl2_C1_BK5_ld: Transaction = Transaction(app_rosace_cg0_cl2_C1 read rosace.ddr.BK5)
  tr_rosace_cg0_cl2_C1_BK5_ld.used

  val tr_rosace_cg0_cl2_C1_BK5_st: Transaction = Transaction(app_rosace_cg0_cl2_C1 write rosace.ddr.BK5)
  ...
  val tr_rosace_cg0_cl3_C0_BK6_ld: Transaction = Transaction(app_rosace_cg0_cl3_C0 read rosace.ddr.BK6)
  tr_rosace_cg0_cl3_C0_BK6_ld.used

  val tr_rosace_cg0_cl3_C0_BK6_st: Transaction = Transaction(app_rosace_cg0_cl3_C0 write rosace.ddr.BK6)
  tr_rosace_cg0_cl3_C0_BK6_st.used

  val tr_rosace_cg0_cl3_C1_l1_ld: Transaction = Transaction(app_rosace_cg0_cl3_C1 read rosace.cg0.cl3.C1_L1)
  tr_rosace_cg0_cl3_C1_l1_ld.used

  val tr_rosace_cg0_cl3_C1_l1_st: Transaction = Transaction(app_rosace_cg0_cl3_C1 write rosace.cg0.cl3.C1_L1)
  tr_rosace_cg0_cl3_C1_l1_st.used

  val tr_rosace_cg0_cl3_C1_l2_ld: Transaction = Transaction(app_rosace_cg0_cl3_C1 read rosace.cg0.cl3.l2)
  tr_rosace_cg0_cl3_C1_l2_ld.used

  val tr_rosace_cg0_cl3_C1_l2_st: Transaction = Transaction(app_rosace_cg0_cl3_C1 write rosace.cg0.cl3.l2)
  tr_rosace_cg0_cl3_C1_l2_st.used

  val tr_rosace_cg0_cl3_C1_BK7_ld: Transaction = Transaction(app_rosace_cg0_cl3_C1 read rosace.ddr.BK7)
  tr_rosace_cg0_cl3_C1_BK7_ld.used

  val tr_rosace_cg0_cl3_C1_BK7_st: Transaction = Transaction(app_rosace_cg0_cl3_C1 write rosace.ddr.BK7)
