...
trait HbusCl2C2B8TransactionLibrary extends TransactionLibrary {
  ...
  val tr_rosace_cg0_cl1_C0_BK5_ld: Transaction = Transaction(app_rosace_cg0_cl1_C0 read rosace.ddr.BK5)
  tr_rosace_cg0_cl1_C0_BK5_ld.used

  val tr_rosace_cg0_cl1_C0_BK5_st: Transaction = Transaction(app_rosace_cg0_cl1_C0 write rosace.ddr.BK5)
  ...
  val tr_rosace_cg0_cl1_C1_BK6_ld: Transaction = Transaction(app_rosace_cg0_cl1_C1 read rosace.ddr.BK6)
  tr_rosace_cg0_cl1_C1_BK6_ld.used

  val tr_rosace_cg0_cl1_C1_BK6_st: Transaction = Transaction(app_rosace_cg0_cl1_C1 write rosace.ddr.BK6)
  tr_rosace_cg0_cl1_C1_BK6_st.used

  val tr_rosace_cg0_cl1_C1_BK7_ld: Transaction = Transaction(app_rosace_cg0_cl1_C1 read rosace.ddr.BK7)
  tr_rosace_cg0_cl1_C1_BK7_ld.used

  val tr_rosace_cg0_cl1_C1_BK7_st: Transaction = Transaction(app_rosace_cg0_cl1_C1 write rosace.ddr.BK7)
