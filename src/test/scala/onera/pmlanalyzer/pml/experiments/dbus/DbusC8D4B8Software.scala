...
trait DbusC8D4B8Software {
  self: DbusC8D4B8Platform =>
  ...
  val app_rosace_cg0_cl0_C4: Application = Application()
  app_rosace_cg0_cl0_C4 hostedBy rosace.cg0.cl0.C4

  val app_rosace_cg0_cl0_C5: Application = Application()
  app_rosace_cg0_cl0_C5 hostedBy rosace.cg0.cl0.C5

  val app_rosace_cg0_cl0_C6: Application = Application()
  app_rosace_cg0_cl0_C6 hostedBy rosace.cg0.cl0.C6

  val app_rosace_cg0_cl0_C7: Application = Application()
  app_rosace_cg0_cl0_C7 hostedBy rosace.cg0.cl0.C7
