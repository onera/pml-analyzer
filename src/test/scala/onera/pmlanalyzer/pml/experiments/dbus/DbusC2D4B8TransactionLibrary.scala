...
trait DbusC2D4B8TransactionLibrary extends TransactionLibrary {
  self: DbusC2D4B8Platform with DbusC2D4B8Software =>
  ...
  val tr_rosace_cg0_cl0_C0_BK2_ld: Transaction = Transaction(app_rosace_cg0_cl0_C0 read rosace.ddr.BK2)
  tr_rosace_cg0_cl0_C0_BK2_ld.used

  val tr_rosace_cg0_cl0_C0_BK2_st: Transaction = Transaction(app_rosace_cg0_cl0_C0 write rosace.ddr.BK2)
  tr_rosace_cg0_cl0_C0_BK2_st.used

  val tr_rosace_cg0_cl0_C0_BK3_ld: Transaction = Transaction(app_rosace_cg0_cl0_C0 read rosace.ddr.BK3)
  tr_rosace_cg0_cl0_C0_BK3_ld.used

  val tr_rosace_cg0_cl0_C0_BK3_st: Transaction = Transaction(app_rosace_cg0_cl0_C0 write rosace.ddr.BK3)
  ...
  val tr_rosace_cg0_cl0_C1_BK4_ld: Transaction = Transaction(app_rosace_cg0_cl0_C1 read rosace.ddr.BK4)
  tr_rosace_cg0_cl0_C1_BK4_ld.used

  val tr_rosace_cg0_cl0_C1_BK4_st: Transaction = Transaction(app_rosace_cg0_cl0_C1 write rosace.ddr.BK4)
  tr_rosace_cg0_cl0_C1_BK4_st.used

  val tr_rosace_cg0_cl0_C1_BK5_ld: Transaction = Transaction(app_rosace_cg0_cl0_C1 read rosace.ddr.BK5)
  tr_rosace_cg0_cl0_C1_BK5_ld.used

  val tr_rosace_cg0_cl0_C1_BK5_st: Transaction = Transaction(app_rosace_cg0_cl0_C1 write rosace.ddr.BK5)
  tr_rosace_cg0_cl0_C1_BK5_st.used

  val tr_rosace_cg0_cl0_C1_BK6_ld: Transaction = Transaction(app_rosace_cg0_cl0_C1 read rosace.ddr.BK6)
  tr_rosace_cg0_cl0_C1_BK6_ld.used

  val tr_rosace_cg0_cl0_C1_BK6_st: Transaction = Transaction(app_rosace_cg0_cl0_C1 write rosace.ddr.BK6)
  tr_rosace_cg0_cl0_C1_BK6_st.used

  val tr_rosace_cg0_cl0_C1_BK7_ld: Transaction = Transaction(app_rosace_cg0_cl0_C1 read rosace.ddr.BK7)
  tr_rosace_cg0_cl0_C1_BK7_ld.used

  val tr_rosace_cg0_cl0_C1_BK7_st: Transaction = Transaction(app_rosace_cg0_cl0_C1 write rosace.ddr.BK7)
