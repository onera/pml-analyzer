...
trait DbusC4D8B8TransactionLibrary extends TransactionLibrary {
  ...
  val tr_rosace_cg0_cl0_C1_BK2_ld: Transaction = Transaction(
    app_rosace_cg0_cl0_C1 read rosace.ddr.BK2
  )
  tr_rosace_cg0_cl0_C1_BK2_ld.used

  val tr_rosace_cg0_cl0_C1_BK2_st: Transaction = Transaction(
    app_rosace_cg0_cl0_C1 write rosace.ddr.BK2
  )
  tr_rosace_cg0_cl0_C1_BK2_st.used

  val tr_rosace_cg0_cl0_C1_BK3_ld: Transaction = Transaction(
    app_rosace_cg0_cl0_C1 read rosace.ddr.BK3
  )
  tr_rosace_cg0_cl0_C1_BK3_ld.used

  val tr_rosace_cg0_cl0_C1_BK3_st: Transaction = Transaction(
    app_rosace_cg0_cl0_C1 write rosace.ddr.BK3
  )
  ...
  val tr_rosace_cg0_cl0_C2_BK4_ld: Transaction = Transaction(
    app_rosace_cg0_cl0_C2 read rosace.ddr.BK4
  )
  tr_rosace_cg0_cl0_C2_BK4_ld.used

  val tr_rosace_cg0_cl0_C2_BK4_st: Transaction = Transaction(
    app_rosace_cg0_cl0_C2 write rosace.ddr.BK4
  )
  tr_rosace_cg0_cl0_C2_BK4_st.used

  val tr_rosace_cg0_cl0_C2_BK5_ld: Transaction = Transaction(
    app_rosace_cg0_cl0_C2 read rosace.ddr.BK5
  )
  tr_rosace_cg0_cl0_C2_BK5_ld.used

  val tr_rosace_cg0_cl0_C2_BK5_st: Transaction = Transaction(
    app_rosace_cg0_cl0_C2 write rosace.ddr.BK5
  )
  ...
  val tr_rosace_cg0_cl0_C3_BK6_ld: Transaction = Transaction(
    app_rosace_cg0_cl0_C3 read rosace.ddr.BK6
  )
  tr_rosace_cg0_cl0_C3_BK6_ld.used

  val tr_rosace_cg0_cl0_C3_BK6_st: Transaction = Transaction(
    app_rosace_cg0_cl0_C3 write rosace.ddr.BK6
  )
  tr_rosace_cg0_cl0_C3_BK6_st.used

  val tr_rosace_cg0_cl0_C3_BK7_ld: Transaction = Transaction(
    app_rosace_cg0_cl0_C3 read rosace.ddr.BK7
  )
  tr_rosace_cg0_cl0_C3_BK7_ld.used

  val tr_rosace_cg0_cl0_C3_BK7_st: Transaction = Transaction(
    app_rosace_cg0_cl0_C3 write rosace.ddr.BK7
  )
  ...
  val tr_rosace_dg0_cl0_C4_sram_ld: Transaction = Transaction(
    app_rosace_dg0_cl0_C4 read rosace.dg0.cl0.C4_SRAM
  )
  tr_rosace_dg0_cl0_C4_sram_ld.used

  val tr_rosace_dg0_cl0_C4_sram_st: Transaction = Transaction(
    app_rosace_dg0_cl0_C4 write rosace.dg0.cl0.C4_SRAM
  )
  tr_rosace_dg0_cl0_C4_sram_st.used

  val tr_rosace_dg0_cl0_C5_sram_ld: Transaction = Transaction(
    app_rosace_dg0_cl0_C5 read rosace.dg0.cl0.C5_SRAM
  )
  tr_rosace_dg0_cl0_C5_sram_ld.used

  val tr_rosace_dg0_cl0_C5_sram_st: Transaction = Transaction(
    app_rosace_dg0_cl0_C5 write rosace.dg0.cl0.C5_SRAM
  )
  tr_rosace_dg0_cl0_C5_sram_st.used

  val tr_rosace_dg0_cl0_C6_sram_ld: Transaction = Transaction(
    app_rosace_dg0_cl0_C6 read rosace.dg0.cl0.C6_SRAM
  )
  tr_rosace_dg0_cl0_C6_sram_ld.used

  val tr_rosace_dg0_cl0_C6_sram_st: Transaction = Transaction(
    app_rosace_dg0_cl0_C6 write rosace.dg0.cl0.C6_SRAM
  )
  tr_rosace_dg0_cl0_C6_sram_st.used

  val tr_rosace_dg0_cl0_C7_sram_ld: Transaction = Transaction(
    app_rosace_dg0_cl0_C7 read rosace.dg0.cl0.C7_SRAM
  )
  tr_rosace_dg0_cl0_C7_sram_ld.used

  val tr_rosace_dg0_cl0_C7_sram_st: Transaction = Transaction(
    app_rosace_dg0_cl0_C7 write rosace.dg0.cl0.C7_SRAM
  )
