...
class DbusC2D2B8Test extends AnyFlatSpec with should.Matchers {
  ...
  "DbusC2D2B8" should "be analysable to perform interference calculus" in {
    DbusC2D2B8.transactionByUserName.size shouldEqual 32
    DbusC2D2B8.scenarioByUserName.size shouldEqual 36
    DbusC2D2B8.transactions.size shouldEqual 36
    DbusC2D2B8.purifiedTransactions.size shouldEqual 36
    DbusC2D2B8.purifiedScenarios.size shouldEqual 34
  }
}
