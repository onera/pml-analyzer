...
object SimpleT1042Export extends App {
  ...
  object SimpleT1042ConfiguredFull extends SimpleT1042Platform(Symbol("SimpleFull"))
  ...
  object SimpleT1042ConfiguredNoL1 extends SimpleT1042Platform(Symbol("SimpleNoL1"))
    with SimpleT1042LibraryConfigurationNoL1
    with SimpleRoutingConfiguration
    with SimpleT1042PhysicalTableBasedInterferenceSpecification
    with SimpleT1042ApplicativeTableBasedInterferenceSpecification

  object SimpleT1042ConfiguredPlanApp21 extends SimpleT1042Platform(Symbol("SimplePlanApp21"))
    with SimpleT1042LibraryConfigurationPlanApp21
    with SimpleRoutingConfiguration
    with SimpleT1042PhysicalTableBasedInterferenceSpecification
    with SimpleT1042ApplicativeTableBasedInterferenceSpecification

  object SimpleT1042ConfiguredPlanApp22 extends SimpleT1042Platform(Symbol("SimplePlanApp22"))
    with SimpleT1042LibraryConfigurationPlanApp22
    with SimpleRoutingConfiguration
    with SimpleT1042PhysicalTableBasedInterferenceSpecification
    with SimpleT1042ApplicativeTableBasedInterferenceSpecification

  for (p <- Set(SimpleT1042ConfiguredFull,SimpleT1042ConfiguredNoL1,SimpleT1042ConfiguredPlanApp21,SimpleT1042ConfiguredPlanApp22))  {
