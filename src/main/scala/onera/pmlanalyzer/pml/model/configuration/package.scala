...
/** Package containing configuration PML facet of a model
  ...
  * [[pml.examples.simpleKeystone.SimpleKeystoneTransactionLibrary]]
  *
  * Example of selection are provided in
  * [[pml.examples.simpleKeystone.SimpleKeystoneLibraryConfigurationFull]]
  */
