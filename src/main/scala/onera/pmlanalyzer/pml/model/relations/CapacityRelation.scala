...
private[pmlanalyzer] final case class CapacityRelation[L, R] private (iniValues: Map[L, R])
    extends Function[L, R](iniValues)

private[pmlanalyzer] object CapacityRelation {

  given (using c: Instances): CapacityRelation[Service, Int] =
    c.capacityOfService
