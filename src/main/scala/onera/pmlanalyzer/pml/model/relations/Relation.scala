...
/**
  * Relation between two finite sets
  * Warning each one of the set contains the empty set value thus
  * R(a) = \emptyset not imply that a \notin R
  *
  * @param iniValues initial values of the relation
  * @tparam L type of the left set
  * @tparam R type of the right set
  */
abstract class Relation[L, R](iniValues: Map[L, Set[R]])(using n:Name) {
  
  val name: String = n.value

  val _values: MHashMap[L, MSet[R]] = MHashMap(iniValues.map(p => p._1 -> MSet(p._2.toSeq: _*)).toSeq: _*)
  val _inverse: MHashMap[R, MSet[L]] = _values.flatMap(p => p._2.map(b => b -> MSet(p._1)))
  ...
  /**
    * Add a collection of b elements to a
    * Warning if the b is empty then all the element linked to a are removed (STRANGE)
    *
    * @param a the input element
    * @param b the collection of new elements
    */
  ...
  /**
    ...
    *
    * @param a the input element
    * @param b the removed elements
    */
  def remove(a: L, b: Iterable[R]): Unit = b.foreach(remove(a, _))

  /**
    * Remove a from the relation
    * WARNING: this is different from removing all elements in relation with a
    *
    * @param a the input element
    */
  ...
  /**
    * Provide the elements in relation with a
    * WARNING the function returns an empty set either
    * if a is not in the relation
    * or if no elements are associated to a
    *
    * @param a the input element
  ...
  /**
    ...
    *
    * @param a the input element
    * @return the optional set of related elements
    */
  ...
  /**
    ...
    *
    * @param b the output element
    * @return the set of related inputs
    */
  ...
  /**
    ...
    *
    * @return the set of output elements
    */
  ...
  /**
    ...
    *
    * @return the set of input elements
    */
...
object Relation {
  /**
    ...
    */
  trait Instances extends LinkRelation.Instances
