...
/**
  ...
  *
  * @tparam T the type of the deactivatable component
  */
trait Deactivate[-T] {
  def apply(a: T): Unit
}
...
object Deactivate {
  ...
  /**
    ...
    * }}}
    *
    * @note currently any [[pml.model.hardware.Hardware]] or [[pml.model.software.Application]] is deactivatable
    *       and the deactivation can be made only within a platform container
    */
  ...
  /**
    ...
    * @return the implementation of application deactivation
    */
  given (using uSL: UseRelation[Application, Service], uAS: UseRelation[Application, Initiator]): Deactivate[Application] with {
  ...
  /**
    ...
    * @return the implementation of physical component deactivation
    */
  given (using l: LinkRelation[Service], p: ProvideRelation[Hardware, Service], u: UseRelation[Application, Service]): Deactivate[Hardware] with {
