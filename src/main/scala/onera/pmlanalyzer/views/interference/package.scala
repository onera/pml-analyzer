...
/**
  ...
  *
  * @see [[views.interference.model]] for basic classes used to model the interference analysis assumption
  * @see [[views.interference.operators]] for operators used to manipulate and perform analyses
  * @see [[views.interference.exporters]] for exporters
  * @see [[views.interference.examples]] for examples on operator and class usage and
