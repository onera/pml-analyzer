...
import onera.pmlanalyzer.pml.examples.mySys.{MySysLibraryConfiguration, MyProcPlatform, MySysTransactionLibrary, MySysSoftwareAllocation}
...
/**
  * The interference calculus assumptions for the MySys's applications are gathered here.
