 ...
 */
private[pmlanalyzer] sealed trait BaseBDDFactory[Var, MyBDD <: JavaBDD] {
 ...
 * the type of variable labelled on BDD nodes
 */
private[pmlanalyzer] sealed trait GenBDDFactory[Var]
    extends BaseBDDFactory[Var, JavaBDD] {
...
/** BDDFactory where variables labelled on BDD node are InstBoolIdent
  */
private[pmlanalyzer] final class SymbolBDDFactory
    extends GenBDDFactory[Symbol] {
...
/** Class for a classic BDD Factory (variable are integer and BDD are JavaBDD)
  */
private[pmlanalyzer] final class BDDFactory
    extends BaseBDDFactory[Int, JavaBDD] {
