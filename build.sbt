...
lazy val dockerSettings = Seq(
  ...
  docker / dockerfile := {
    ...
    new Dockerfile {
      from("ubuntu:latest")
      customInstruction("RUN", "apt-get update && apt-get --fix-missing update && apt-get install -y openjdk-17 git graphviz gnupg libgmp3-dev make cmake build-essential zlib1g-dev")
